...
void MyRectangle::set(int x_1, int y_1, int x_2, int y_2) 
{ 
	set_x1(x_1); set_y1(y_1); set_x2(x_2); set_y2(y_2); 
}
...
//(x1 <= x1_2 <= x2 && y1 <= y1_2 <= y2 || x1 <= x2_2 <= x2 && y1 <= y2_2 <= y2 || x1_2 < x1 && x1_2 > x2 && y1_2 < y1 && y2_2 > y2)